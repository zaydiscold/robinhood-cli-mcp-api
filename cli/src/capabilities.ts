...
export const CAPABILITIES: readonly CapabilityDefinition[] = [
  ...
  {
    id: "internal-transfer-quote",
    cli: "internal-transfer-quote",
    mcp: "robinhood_internal_transfer_quote",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "internal-transfer-plan",
    cli: "internal-transfer-plan",
    mcp: "robinhood_internal_transfer_plan",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "internal-transfer-execute",
    cli: "internal-transfer-execute",
    mcp: "robinhood_internal_transfer_execute",
    access: "write",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "money-movement-verify",
    cli: "money-movement-verify",
    mcp: "robinhood_money_movement_verify",
    access: "write",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "money-movement-quote",
    cli: "money-movement-quote",
    mcp: "robinhood_money_movement_quote",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "money-movement-receipt",
    cli: "money-movement-receipt",
    mcp: "robinhood_money_movement_receipt",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "money-movement-resume",
    cli: "money-movement-resume",
    mcp: "robinhood_money_movement_resume",
    access: "write",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "internal-transfer-inventory",
    cli: "internal-transfer-inventory",
    mcp: "robinhood_internal_transfer_inventory",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  ...
  {
    id: "withdrawal-quote",
    cli: "withdrawal-quote",
    mcp: "robinhood_withdrawal_quote",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  ...
  },
  {
    id: "withdrawal-plan",
    cli: "withdrawal-plan",
    mcp: "robinhood_withdrawal_plan",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "withdrawal-execute",
    cli: "withdrawal-execute",
    mcp: "robinhood_withdrawal_execute",
    access: "write",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "withdrawal-inventory",
    cli: "withdrawal-inventory",
    mcp: "robinhood_withdrawal_inventory",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
  {
    id: "deposit-inventory",
    cli: "deposit-inventory",
    mcp: "robinhood_deposit_inventory",
    access: "read",
    profiles: ["full"],
    outputSchema: "legacyObject",
  },
