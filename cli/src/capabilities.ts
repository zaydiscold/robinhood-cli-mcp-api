...
export const CAPABILITIES: readonly CapabilityDefinition[] = [
  ...
  },
  {
    id: "options-history",
    cli: "options history",
    mcp: "robinhood_options_history",
    access: "read",
    profiles: profilesForMcp("robinhood_options_history"),
    outputSchema: "legacyObject",
  },
  {
    id: "options-chain-stats",
    cli: "options chain-stats",
    mcp: "robinhood_options_chain_stats",
    access: "read",
    profiles: profilesForMcp("robinhood_options_chain_stats"),
    outputSchema: "legacyObject",
  },
  {
    id: "options-snapshot",
    cli: "options snapshot",
    mcp: "robinhood_options_snapshot",
    access: "read",
    profiles: profilesForMcp("robinhood_options_snapshot"),
    outputSchema: "legacyObject",
  },
  {
